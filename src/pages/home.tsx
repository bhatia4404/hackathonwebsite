...
import blueCrossIcon from "../img/blueClose.svg";
import { ExpandableSectionElement } from "../components/Section";
import { HorizontalSideBar, SideBar } from "../components/Sidebar";
  ...
  return (
    <div className="">
                      ...
                      <ExpandableSectionElement
                        ...
                        content={
                          <p className="text-[#3B3C36]">
                            ...
                            across the nation will work together in teams to
                            solve problems and develop creative solutions within
                            a 24 hour timeframe. It shall focus on coding
                            challenges designed to test students' logical
                            thinking, problem-solving abilities, and coding
                            expertise in an offline environment.
                          </p>
                        }
                      />
                      <ExpandableSectionElement
                        ...
                        content={
                          <>
                            <p>
                              You need to build an application (website, app,
                              etc) using{" "}
                              <a href="https://cosmocloud.io">Cosmocloud</a> as
                              your Backend layer for APIs{" "}
                              <strong>(mandatory).</strong>
                            </p>
                            <p>
                              Additionally, you can use these for bonus points
                              in your submission -
                            </p>
                            <br />
                            ...
                            <br />
                            <p>
                              We invite all working professionals and students
                              to take part in this hackathon. We have{" "}
      ...
      <div className="bottom-sidebar bg-white fixed bottom-0 w-[100%] lg:hidden flex flex-col justify-center px-6 shadow-2xl rounded-t-3xl py-2">
        <button
          className="flex items-center p-2 rounded-full shadow-xl w-fit"
          onClick={() =>
            setBottomSideBarVisible(
              (bottomSideBarVisible) => !bottomSideBarVisible
            )
          }
        >
          <img
            src={bottomSideBarVisible ? blueCrossIcon : listIcon}
            alt=""
            className="h-[35px] "
          />
        </button>
        <HorizontalSideBar visible={bottomSideBarVisible} />
      </div>
    </div>
  );
}
